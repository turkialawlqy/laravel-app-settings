<div class="content">
    ...
    <form method="post" action="{{ config('app_settings.url') }}"
                        ...
                        @foreach(Arr::get($fields, 'inputs', []) as $field)
                            @if(!view()->exists('app_settings::fields.' . $field['type']))
                                <div
                                    ...
                                    You can create a <code>fields/{{ $field['type'] }}.balde.php</code>
                                    to render this input however you want.
                                </div>
                            @endif
        ...
        <div class="row m-b-md">
            <div class="col-md-12">
                <button class="btn-primary btn">
                    {{ __(Arr::get($settingsUI, 'submit_btn_text', 'Save Settings')) }}
                </button>
            </div>
        </div>
    </form>
